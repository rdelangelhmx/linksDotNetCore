...
$(function() {
  ...
  MINOVATE.global = {
    ...
    layout: function() {
      var defaultHeaderScheme = 'scheme-greensea',
          defaultNavbarScheme = 'scheme-light',
          defaultBrandingScheme = 'scheme-greensea',
          ...
          defaultAppClasses = 'scheme-greensea greensea-scheme-color header-fixed aside-fixed rightbar-hidden';
